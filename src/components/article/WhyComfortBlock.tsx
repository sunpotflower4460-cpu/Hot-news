...
export function WhyComfortBlock({ text }: { text: string }) {
  return (
    <aside className="relative overflow-hidden rounded-panel border border-accent/10 bg-accent-soft/62 p-5 shadow-inner-light">
      ...
      <div className="relative flex items-center gap-2 text-accent">
        <span className="flex h-8 w-8 items-center justify-center rounded-full bg-white/38 shadow-inner-light backdrop-blur-sm">
          <Sparkles size={15} className="fill-accent/16" />
        </span>
