    ...
    >
      ...
      <LegalSection title="2. 現在取り扱う情報">
        ...
        <ul className="list-disc space-y-1.5 pl-5">
          <li>保存した記事の識別子</li>
          <li>最近開いた記事の識別子と日時（最大50件、最長30日）</li>
      ...
      <LegalSection title="6. 利用目的">
        <ul className="list-disc space-y-1.5 pl-5">
          <li>利用者が選んだ表示・通知・保存設定を端末内で維持するため</li>
          <li>今日開いた記事の数を示し、保存し忘れた記事へ戻れるようにするため</li>
      ...
      <LegalSection title="8. 保存期間と削除">
        <p>
          最近開いた記事の履歴は最大50件まで保持し、30日を過ぎたものを自動で整理します。その他の端末内データは、利用者がアプリ内の「プライバシー」から削除するか、ブラウザ・OSの保存領域を消去するまで保持されます。
        </p>
        <p>
          アプリ内の削除操作では、保存した記事、最近読んだ履歴、設定、同意履歴、対象キャッシュをまとめて削除できます。
        </p>
      </LegalSection>
